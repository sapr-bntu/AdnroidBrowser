...
**
** Created: Thu 1. Mar 17:09:12 2012
...
static const char qt_meta_stringdata_Browser[] = {
    ...
    "PutIncorrectUrl()\0PutCorrectUrl()\0"
    "UrlWithoutDot()\0UrlWithDot()\0"
    "UrlWithoutDomen()\0UrlWithDomen()\0"
    "UrlWithoutHTTP()\0UrlWithHTTP()\0"
    "ComboboxClear()\0"
};
...
void Browser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 13: { bool _r = _t->PutIncorrectUrl();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 14: { bool _r = _t->PutCorrectUrl();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 15: { bool _r = _t->UrlWithoutDot();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 16: { bool _r = _t->UrlWithDot();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 17: { bool _r = _t->UrlWithoutDomen();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 18: { bool _r = _t->UrlWithDomen();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 19: { bool _r = _t->UrlWithoutHTTP();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 20: { bool _r = _t->UrlWithHTTP();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
